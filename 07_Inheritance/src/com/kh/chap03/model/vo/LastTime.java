...
// 1절
/*    <=  우리가 이런 걸 굳이 안하고도 사용할 수 있었죠. extends 가 기본적으로 되어있기 때문입니다.
...
public class LastTime extends Object {
	...
	public void setName(String name) {
		this.name = name;
		/*return;*/ // 원래 있어야하는데 생략되어있을 뿐 => 자동생성
	}
	
	/*
	 * Overriding 오버라이딩
	 * 
	 * - 상속받고 있는 부모클래스의 메소드를 자식클래스에서 재정의(다시씀)
	 ...
	 * 왜 붙여야하나요??
	 * => 실수를 줄일 수 있다!
	 * => 누가봐도 오버라이딩이라고 알아볼 수 있음.("부모클래스꺼 다시 썼다~!")
	 */
	@Override
	public String toString() { // 앞으로 info 를 사용할 필요가 없겠네요?
