...
public class Run {
	...
	public static void main(String[] args) {
		...
		// 1절
		// 사용자로부터 식당의 정보를 입력받아서
		// 입력받은 식당의 정보를 출력해주는 프로그램
		// 3개의 식당정보를 입력받겠다고 가정
		
		
		Scanner sc = new Scanner(System.in);
		//Restaurant r = new Restaurant(storeName, address, mainMenu);  // <= 매개변수 개수, 필드에 대입하고 싶은 순서, 자료형이 일치해야합니다.
		Restaurant r0 = null;
		Restaurant r1 = null;
		Restaurant r2 = null;
		...
		System.out.print("식당의 메인메뉴를 입력해주세요 > ");
	...
	*/
		...
		if(searched.equals(r0.getStoreName())) {
			System.out.println("메인메뉴 : " + r0.getMainMenu());
		}
		
		if(searched.equals(r1.getStoreName())) {
			System.out.println("메인메뉴 : " + r1.getMainMenu());
		}
		
		if(searched.equals(r2.getStoreName())) {
			System.out.println("메인메뉴 : " + r2.getMainMenu());
		}
